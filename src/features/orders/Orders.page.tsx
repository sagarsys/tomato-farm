...
const sellOrderColumns: ColumnDef<SellOrder>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="text-right">{(metrics.totalVolume)}</div>
      );
    },
  },
  {
    ...
    cell: ({ row }) => {
      const metrics = calculateSellOrderMetrics(row.original);
      return (
        <div className="text-right">{(metrics.totalCost)}</div>
      );
    },
  },
  {
...
const buyOrderColumns: ColumnDef<BuyOrder>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="text-right">{(metrics.volume)}</div>
      );
    },
  },
  {
      ...
      {orderType === "sell" ? (
          ...
          <CardHeader className="px-7">
            ...
            <div className="flex gap-4 flex-wrap">
              <CardDescription className="text-lg font-semibold text-green-600">
                Total Revenue: {(sellOrderTotals.totalRevenue)}
              </CardDescription>
              <CardDescription className="text-lg font-semibold text-blue-600">
                Total Profit: {(sellOrderTotals.totalProfit)}
              </CardDescription>
              <CardDescription className="text-lg font-semibold">
                Total Cost: {(sellOrderTotals.totalCost)}
              </CardDescription>
            </div>
            <div className="flex gap-4 flex-wrap text-sm">
              ...
              <CardDescription>
                Volume: {(sellOrderTotals.totalVolume)} kg
              </CardDescription>
        ...
        <Card>
          <CardHeader className="px-7">
            ...
            <div className="flex gap-4 flex-wrap">
              <CardDescription className="text-lg font-semibold">
                Total Cost: {(buyOrderTotals.totalCost)}
              </CardDescription>
              <CardDescription className="text-lg font-semibold">
                Total Volume: {(buyOrderTotals.totalVolume)} kg
              </CardDescription>
            </div>
            <div className="flex gap-4 flex-wrap text-sm">
              <CardDescription>
